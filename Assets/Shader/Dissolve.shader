...
Shader "Shader Forge/Dissolve" {
    Properties {
        ...
        _ClipAmount ("Clip Amount", Range(0, 1)) = 0.4822013
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_7856 = (_DissolvePattern_var.r+(_ClipAmount*1.3+-0.5));
                clip(node_7856 - 0.5);
////// Lighting:
////// Emissive:
